...
// Command aigis-ee is the Enterprise Edition entrypoint. It reuses the entire
// open-source core (config, logging, gateway server) and layers Enterprise
// middleware (inbound auth / multi-tenant) on top via server.Use before start.
package main
